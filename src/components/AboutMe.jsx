...
export default function AboutMe() {
    return (
        <div id="#about-me" className="max-w-6xl mx-auto flex flex-col gap-y-8 pt-20 mt-20">
            <h3 className="font-bold text-center text-3xl">About me</h3>
            <div className="flex gap-x-16 justify-evenly">
                <div className="min-w-[30%]  grow-0 flex justify-center items-center " data-aos="fade-up">
                    <img className="object-contain h-auto w-full" src={MyImage} alt="avatar"></img>
                </div>
                <div className="grow flex flex-col pb-4 justify-end shrink">
